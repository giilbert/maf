...
Cobble can optionally generate TypeScript types for your app's data models. This is
...
1\. Add the following to your `cobble-project.toml`:
...
2\. Enable Rust introspection by implementing `schemars::JsonSchema` in
serialized types.
...
5\. Change `CobbleClient` to `TypedCobbleClient` in your client code:
