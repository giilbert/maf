...
<Tabs defaultValue="macos-linux" docId="quickstart-install-maf-cli">
  <TabsList>
...
<Tabs defaultValue="rust" docId="quickstart-write-maf-server">
  <TabsList>
...
<Tabs defaultValue="javascript-typescript" docId="quickstart-use-maf-client">
  <TabsList>
