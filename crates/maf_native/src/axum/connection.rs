...
/// Converts an axum WebSocket Message into a maf PlatformMessage, failing if the axum message is an
...
/// Converts a maf PlatformMessage into an axum WebSocket Message.
