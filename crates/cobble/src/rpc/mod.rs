...
//!
//! It allows a Cobble client to call functions on the server and receive responses.
//!
//! ## Parameters
...
use cobble_schemas::packet::{TypedRpcRequestPacket, TypedRpcResponsePacket};
