...
use anyhow::Context;
use cobble_schemas::typed::{AppSchema, StoreSerialized};
...
impl TypeScriptCodegen {
    ...
    pub fn emit(&self) -> anyhow::Result<String> {
        ...
        output.push_str("// This file is generated by cobble. Do not edit manually.\n\n");

        output.push_str("// prettier-ignore\n");
        output.push_str("export type CobbleStoresList = {\n");
        ...
        output.push_str("// prettier-ignore\n");
        output.push_str("export type CobbleRpcsList = {\n");
...
"#,
    ...
    fn emit_rpc(&self, rpc: &cobble_schemas::typed::RpcSerialized) -> anyhow::Result<String> {
        Ok(format!(
            "\"{name}\": {{\n  name: \"{name}\";\n  params: {};\n  result: {};\n}};",
...
mod tests {
    ...
    fn create_default_codegen() -> super::TypeScriptCodegen {
        let schema = cobble_schemas::typed::AppSchema {
            stores: vec![],
            rpcs: vec![],
        };
