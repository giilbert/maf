...
use cobble_container::{
    server::{Bundle, RoomInner},
    ContainerResourceLimit,
};
use cobble_schemas::apps::{generate_room_secret, RoomCreationStrategy, RoomId};
...
///
/// Compared to `RoomsStorage` in `cobble_container_host`, this is a simplified version that allows
